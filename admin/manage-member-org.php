...
<html lang="en">
  <head>
    <title>HWFC  Management System|||View Officer and Member List (<?=$org_name?>)</title>
    <!-- plugins:css -->
        ...
        <div class="main-panel">
          <div class="content-wrapper">
             <div class="page-header">
              <h3 class="page-title"> View Officer and Member List (<?=$org_name?>) </h3>
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
                  <li class="breadcrumb-item active" aria-current="page"> View Officer and Member List (<?=$org_name?>)</li>
                </ol>
              </nav>
            </div>
            <div class="row">
              <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="py-2">
                        <button class="btn btn-primary btn-sm" style="border-radius:50px" data-toggle="modal" data-target="#addMemeber">Add New</button>
                    </div>
                                      ...
                                      $org_name_id= $row["org_mem_name_id"];
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                  <a href="inputConfig.php?delete_mem_org=<?=$row['org_mem_id']?>" title="delete" onclick="return confirm('Do you really want to Delete ?');"><i class="icon-trash"></i></a>
                                                </td>
                                            </tr>
                                        <?php
                                    }
            ...
            <div class="row">
              <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <div class="mb-4">
                      <h4 class="card-title mb-sm-0">Memeber List (<?=$org_name?>)</h4>
                    </div>
                    <div class="table-responsive border rounded p-1" id="result">
                        <table class="table">
                        <thead>
                        ...
                        <tbody>
                            <?php
                                $fetch_org_mem = new fetch();
                                $res = $fetch_org_mem->fetchOrgNonMem($value);
