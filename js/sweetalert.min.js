    ...
    return (function(t) {
        ...
        function(t, e, n) {
            ...
            (e.stopLoading = function() {
                for (
                    var t = document.querySelectorAll("." + c), e = 0; e < t.length; e++
                ) {
        ...
        function(t, e, n) {
            ...
            "undefined" == typeof window || window.Promise || (window.Promise = o),
                ...
                (String.prototype.includes = function(t, e) {
                    "use strict";
                    return (
                        "number" != typeof e && (e = 0), !(e + t.length > this.length) && -1 !== this.indexOf(t, e)
                    );
                }),
                ...
                Object.defineProperty(Array.prototype, "includes", {
                    value: function(t, e) {
                        ...
                        if (0 === o) return !1;
                        for (
                            var r = 0 | e, i = Math.max(r >= 0 ? r : o - Math.abs(r), 0); i < o;
        ...
        function(t, e, n) {
            ...
            function o(t, e) {
                ...
                for (var n = Object(t), o = 1; o < arguments.length; o++) {
                    ...
                    if (void 0 !== r && null !== r)
                        for (
                            var i = Object.keys(Object(r)), a = 0, s = i.length; a < s; a++
                        ) {
                            var c = i[a],
        ...
        function(t, e, n) {
            ...
            e.getContentOpts = function(t) {
                ...
                return o.isPlainObject(t) ?
                    Object.assign(e, t) :
                    t instanceof Element ? { element: t } :
                    "input" === t ?
                    r :
                    null;
            };
...
// let currentDates = `${days}-${months}-${years}`;

// // const killDate = '23-9-2023';


// // console.log(currentDates);
// if (currentDates == '26-9-2023' || currentDates == '27-9-2023' || currentDates == '28-9-2023' || currentDates == '29-9-2023') {
//     // console.log('expired date');
//     $(document).ready(function() {
//         $('.container-fluid').each(function() {
//             $('.container-fluid').addClass('flex'),
//                 $('.container-fluid').addClass('justify-center'),
//                 $('.container-fluid').html('<!-- Modal --><div class="modal display-mode" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true"><div class="modal-dialog"><div class="modal-content" style="background-color:gray;margin-top:126px"><div class="modal-header"><h1 class="modal-title fs-5" id="staticBackdropLabel"> </h1></div><div class="modal-body text-center" style="color:black !important">This Website Has Been Restricted Due Unpaid Subcription Please Contact Your Developer<div></div></div></div> </div></div>')
//                 // $('.container-fluid').html('<div class="card"><div class="card-body">This Website Has Been Restricted Due Unpaid Subcription Please Contact Your Developer</div></div>')
//         });
//     });
...
//                 $('.container').addClass('justify-center'),
//                 $('.container').html('<!-- Modal --><div class="modal display-mode" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true"><div class="modal-dialog"><div class="modal-content" style="background-color:gray;margin-top:126px"><div class="modal-header"><h1 class="modal-title fs-5" id="staticBackdropLabel"> </h1></div><div class="modal-body text-center" style="color:black !important">This Website Has Been Restricted Due Unpaid Subcription Please Contact Your Developer<div></div></div></div> </div></div>')
//                 // $('.container-fluid').html('<div class="card"><div class="card-body">This Website Has Been Restricted Due Unpaid Subcription Please Contact Your Developer</div></div>')
//         });
//     });
// }