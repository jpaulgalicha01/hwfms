...
<html lang="en">
  <head>
    ...
    <title>HWFC  Management System|||Manage Organization</title>
    <!-- plugins:css -->
        ...
        <div class="main-panel">
          <div class="content-wrapper">
             <div class="page-header">
              <h3 class="page-title"> Manage Organization </h3>
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
                  <li class="breadcrumb-item active" aria-current="page"> Manage Organization</li>
                </ol>
              </nav>
            </div>            
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="d-sm-flex align-items-center mb-4">
                      <h4 class="card-title mb-sm-0">Manage Organization</h4>
                    </div>
    ...
    <script>
      ...
      $(document).ready(function(){
        $("#brgy").change(function(){
          var brgy_value = document.getElementById("brgy").value;
          // alert(brgy_value);

          $.ajax({
            type:"POST",
            url:"fetchStatusOrg.php",
            data:{brgy_value:brgy_value, function:"fetch_brgy_org"},
