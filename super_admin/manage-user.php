...
<html lang="en">
  <head>
    ...
    <title>HWFC  Management System|||View User</title>
    <!-- plugins:css -->
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="form-group">
              ...
              <select class="custom-select" id="org">
              </select>
            </div>
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="d-sm-flex align-items-center mb-4">
                      <h4 class="card-title mb-sm-0">View User</h4>
                    </div>
...
<script>
  $(document).ready(function(){
    $("#brgy").change(function(){
      ...
      $.ajax({
        method:"POST",
        url:"fetchOrgList.php",
        data:{value_brgy:value_brgy,function:"fetch_org"},
