...
$_SESSION['title'] = "List of Candidates";
...
<html lang="en">
  <head>
    ...
    <title>HWFC  Management System|||List of Candidates</title>
    <!-- plugins:css -->
        ...
        <div class="main-panel">
          <div class="content-wrapper">
             <div class="page-header">
              <h3 class="page-title"> List of Candidates (<?=$_REQUEST['year_election']?>)</h3>
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
                  <li class="breadcrumb-item active" aria-current="page"> List of Candidates</li>
                </ol>
              </nav>
            </div>
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="d-sm-flex align-items-center mb-4">
                      <h4 class="card-title mb-sm-0">List of Candidates (<?=$_REQUEST['year_election']?>)</h4>
                    </div>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <button type="button" id="fetch_candidates" class="btn btn-outline-none btn-sm"  value="<?=$row['brgy_name']?>" style="color:#0056b3">
                                              <i class="icon-eye"></i>
                                            </button>
                                        </td>
                                    </tr>
